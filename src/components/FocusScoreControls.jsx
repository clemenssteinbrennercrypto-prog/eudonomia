...
export default function FocusScoreControls({ metricVersion, onVersionChange, scheduleState, now }) {
    ...
    <div className="focus-score-controls">
      ...
      {metricVersion === 2 && (
        <details className="focus-workdays">
          ...
          <p>Unselected days are rest days. Changes apply from tomorrow and preserve past scores.</p>
        </details>
      )}
