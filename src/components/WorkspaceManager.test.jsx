...
describe('WorkspaceManager', () => {
  ...
  it('renders a migrated active workspace in the reusable library', () => {
    ...
    expect(html).toContain('aria-label="Layout for Imported workspace with 2 objects"')
    ...
    expect(html).toContain('data-layout-col="0.5"')
    expect(html).toContain('data-layout-row="0.1"')
  })
})
