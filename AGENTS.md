...
npm test           # vitest, currently 455 tests — must stay green
...
cargo test         # currently 74 tests (13 library + 61 app)
cargo check
```
...
There are currently 455 JS tests and 74 Rust tests (13 native-camera library
tests plus 61 app tests). Both suites must stay green. Treat these counts as a
